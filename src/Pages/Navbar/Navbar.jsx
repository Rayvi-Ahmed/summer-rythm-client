        ...
        <div className="bg-pink-800">
            <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="relative flex items-center justify-between">
                    ...
                    <ul className="flex items-center d-none space-x-8 lg:flex">
                        <li>
                            <a
                                href="/"
                                aria-label="Home"
...

                                                {
                                                    user?.uid ?
                                                        <>
                                                            ...
                                                            <button onClick={handleLogOut} className="inline-flex items-center justify-center px-6 mx-24 lg:mx-0  h-12 font-medium tracking-wide text-black transition duration-200 rounded shadow-md bg-pink-400 hover:bg-teal-700 focus:shadow-outline focus:outline-none">Log out</button>
                                                            <span>{user?.displayName}</span>
                                                        </>
                                                        :
                                                        <>
